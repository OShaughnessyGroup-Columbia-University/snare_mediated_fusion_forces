...
frame_number_arr = [142]
frame_number = frame_number_arr[int(sys.argv[1])//1%1]

filename = 'ves_ves_rtmd_ini_5.91_deltah_1.50_Nunzip_10.00_lp_0.50_nrod_7_rod_r_0.38_dves_55.9_tension_0.05_run_5_863.gsd'
...
f_name = 'ves_ves_cutsnare_nostaple_rtmd_ini_cont_stalk_relax_2.27_deltah_%.2f_nrod_%.0f_rod_r_%.2f_dves_%.1f_tension_%.2f_run_%.0f' % (delta_h,n_rod,rod_bd_dia/2,2*(r_ves+hmem),tension,run)
print(f_name)
hoomd.dump.gsd(f_name+'_ini.gsd',period=None,group=hoomd.group.all(),overwrite=True)
#exit()
...
if __name__ == '__main__':
    ...
    N_run = 500000 # number of timesteps, 1 timestep = 0.068 ns
