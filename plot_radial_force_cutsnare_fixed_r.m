...
for irod = 1:length(nrod_arr)
    ...
    fname = [folder_prefix 'force_data_fixed_coord_cutsnare_nrod_' int2str(nrod) '_rtmd_*.txt'];
    fname_pat = ['force_data_fixed_coord_cutsnare_nrod_' int2str(nrod) '_rtmd_%f.txt'];
