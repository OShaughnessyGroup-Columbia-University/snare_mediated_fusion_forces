...
filename = 'ves_ves_cutsnare_nostaple_rtmd_ini_cont_relax_2.27_deltah_1.00_nrod_7_rod_r_0.38_dves_55.9_tension_0.05_run_1_977.gsd'
...
f_name = 'ves_ves_cutsnare_rtmd_ini_cont_2.27_deltah_%.2f_Nunzip_%.2f_lp_%.2f_nrod_%.0f_rod_r_%.2f_dves_%.1f_tension_%.2f_run_%.0f' % (delta_h,N_unzip,lp,n_rod,rod_bd_dia/2,2*(r_ves+hmem),tension,run)
print(f_name)
hoomd.dump.gsd(f_name+'_ini.gsd',period=None,group=hoomd.group.all(),overwrite=True)
#exit()
